...
describe('diagram semantic verification helper', () => {
    ...
    test('registers a semantic verification helper script and references it in maintainer docs', () => {
        ...
        expect(runbookZh).toContain('Modelo de embalaje actual');
        ...
        expect(runbookZh).toContain('release Disparador、tag Proteccion、workflow-source Ramificacion y chronicle-target Valor de verdad del contrato de sucursal');
        ...
        expect(releaseWorkflowZh).toContain('No significa que se haya logrado un verdadero aislamiento del tiempo de ejecucion de servicio pesado');
        ...
        expect(releaseWorkflowZh).toContain('`createRenderHostBundleBuildOptions()` mantener candidate-only');
        ...
        expect(releaseWorkflowZh).toContain('workflow-source Ramificacion y chronicle-target Sucursal');
