...
- **Output Language**:
  ...
  - **Другие языки**: модели даётся указание выполнять рассуждение на английском, но финальную документацию возвращать на выбранном языке, например Español, Français, Chino simplificado, Chino tradicional, العربية, हिन्दी и др.
- **Change Prompt Word**:
