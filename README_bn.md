...
-   **Output Language**: (নতুন) "Generate from Title" এবং "Batch Generate from Title" task-এর জন্য কাঙ্ক্ষিত output language নির্বাচন করুন।
    ...
    *   **Other Languages**: LLM-কে নির্দেশ দেওয়া হয় যেন reasoning ইংরেজিতে করে কিন্তু চূড়ান্ত ডকুমেন্টেশন আপনার নির্বাচিত ভাষায় দেয় (যেমন Español, Français, Chino simplificado, chino tradicional, العربية, हिन्दी ইত্যাদি)।
